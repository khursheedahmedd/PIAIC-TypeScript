...
let str = ['Ali', 'Khursheed', 'Huzaifa', "Ahmad"];
...
let numArray = [6, 3, 9, 5, 9, 5, 9, 5];
let newArray = Squire(numArray);
...
// Question-15
function maxMinScrore(arr, min, max) {
    let minScore = 0;
    let maxScore = 0;
...
// Question-29
function convertToFahrenheit(temperaturesF) {
